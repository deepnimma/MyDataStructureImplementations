...
public interface SortedStructure<T extends Comparable<T>> extends GenericStructure<T> {
     ...
     */
    public static <E extends Comparable<E>> SortedStructure<E> copyOf(GenericStructure<? extends E> coll) {
     ...
     */
    public SortedStructure<T> subList(int fromIndex, int toIndex);
